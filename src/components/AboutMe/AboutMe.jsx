      ...
      <div className='aboutme__main'>
        <div className='aboutme__info'>
          ...
          <p className='aboutme__description'>
            Родился в Москве. Учился в финансовом институте. Начал изучать
            фронтенд в 2021г. 10 месяцев изучал веб-разработку в
            Яндекс.Практикуме. Увлекаюсь путешествиями, кино, люблю компьютерные
            игры, стримы, аниме.
          </p>
